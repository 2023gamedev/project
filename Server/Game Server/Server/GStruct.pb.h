...
class ZombiePathList;
struct ZombiePathListDefaultTypeInternal;
extern ZombiePathListDefaultTypeInternal _ZombiePathList_default_instance_;
class Zombie_attack;
...
class Zombie_shouting;
struct Zombie_shoutingDefaultTypeInternal;
extern Zombie_shoutingDefaultTypeInternal _Zombie_shouting_default_instance_;
class chatting;
struct chattingDefaultTypeInternal;
extern chattingDefaultTypeInternal _chatting_default_instance_;
class destroy_item;
...
extern detach_itemDefaultTypeInternal _detach_item_default_instance_;
class drop_item;
...
extern slice_vectorDefaultTypeInternal _slice_vector_default_instance_;
}  // namespace Protocol
PROTOBUF_NAMESPACE_OPEN
...
template<> ::Protocol::ZombiePathList* Arena::CreateMaybeMessage<::Protocol::ZombiePathList>(Arena*);
...
template<> ::Protocol::Zombie_shouting* Arena::CreateMaybeMessage<::Protocol::Zombie_shouting>(Arena*);
template<> ::Protocol::chatting* Arena::CreateMaybeMessage<::Protocol::chatting>(Arena*);
template<> ::Protocol::destroy_item* Arena::CreateMaybeMessage<::Protocol::destroy_item>(Arena*);
template<> ::Protocol::detach_item* Arena::CreateMaybeMessage<::Protocol::detach_item>(Arena*);
...
template<> ::Protocol::slice_vector* Arena::CreateMaybeMessage<::Protocol::slice_vector>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace Protocol {
...
class Zombie_shouting final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.Zombie_shouting) */ {
 public:
  inline Zombie_shouting() : Zombie_shouting(nullptr) {}
  ~Zombie_shouting() override;
  explicit PROTOBUF_CONSTEXPR Zombie_shouting(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  Zombie_shouting(const Zombie_shouting& from);
  Zombie_shouting(Zombie_shouting&& from) noexcept
    : Zombie_shouting() {
    *this = ::std::move(from);
  }

  inline Zombie_shouting& operator=(const Zombie_shouting& from) {
    CopyFrom(from);
    return *this;
  }
  inline Zombie_shouting& operator=(Zombie_shouting&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const Zombie_shouting& default_instance() {
    return *internal_default_instance();
  }
  static inline const Zombie_shouting* internal_default_instance() {
    return reinterpret_cast<const Zombie_shouting*>(
               &_Zombie_shouting_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    6;

  friend void swap(Zombie_shouting& a, Zombie_shouting& b) {
    a.Swap(&b);
  }
  inline void Swap(Zombie_shouting* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(Zombie_shouting* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  Zombie_shouting* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<Zombie_shouting>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const Zombie_shouting& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const Zombie_shouting& from) {
    Zombie_shouting::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(Zombie_shouting* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.Zombie_shouting";
  }
  protected:
  explicit Zombie_shouting(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.Zombie_shouting)
 private:
  class _Internal;
...
class ZombiePathList final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.ZombiePathList) */ {
 public:
  inline ZombiePathList() : ZombiePathList(nullptr) {}
  ~ZombiePathList() override;
  explicit PROTOBUF_CONSTEXPR ZombiePathList(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  ZombiePathList(const ZombiePathList& from);
  ZombiePathList(ZombiePathList&& from) noexcept
    : ZombiePathList() {
    *this = ::std::move(from);
  }

  inline ZombiePathList& operator=(const ZombiePathList& from) {
    CopyFrom(from);
    return *this;
  }
  inline ZombiePathList& operator=(ZombiePathList&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const ZombiePathList& default_instance() {
    return *internal_default_instance();
  }
  static inline const ZombiePathList* internal_default_instance() {
    return reinterpret_cast<const ZombiePathList*>(
               &_ZombiePathList_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    10;

  friend void swap(ZombiePathList& a, ZombiePathList& b) {
    a.Swap(&b);
  }
  inline void Swap(ZombiePathList* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(ZombiePathList* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  ZombiePathList* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<ZombiePathList>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const ZombiePathList& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const ZombiePathList& from) {
    ZombiePathList::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(ZombiePathList* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.ZombiePathList";
  }
  protected:
  explicit ZombiePathList(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  enum : int {
    kZombiepathsFieldNumber = 2,
    kPacketTypeFieldNumber = 1,
  };
  // repeated .Protocol.ZombiePath zombiepaths = 2;
  int zombiepaths_size() const;
  private:
  int _internal_zombiepaths_size() const;
  public:
  void clear_zombiepaths();
  ::Protocol::ZombiePath* mutable_zombiepaths(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ZombiePath >*
      mutable_zombiepaths();
  private:
  const ::Protocol::ZombiePath& _internal_zombiepaths(int index) const;
  ::Protocol::ZombiePath* _internal_add_zombiepaths();
  public:
  const ::Protocol::ZombiePath& zombiepaths(int index) const;
  ::Protocol::ZombiePath* add_zombiepaths();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ZombiePath >&
      zombiepaths() const;
  ...
  // @@protoc_insertion_point(class_scope:Protocol.ZombiePathList)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ZombiePath > zombiepaths_;
    uint32_t packet_type_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
...
class drop_item final :
 ...
 public:
  ...
  enum : int {
    ...
    kPosyFieldNumber = 8,
    kPoszFieldNumber = 9,
    kDurabilityFieldNumber = 10,
    kDurabilityMaxFieldNumber = 11,
  };
  // string itemname = 3;
  void clear_itemname();
  const std::string& itemname() const;
  ...
  void clear_durability_max();
  float durability_max() const;
  void set_durability_max(float value);
  private:
  float _internal_durability_max() const;
  void _internal_set_durability_max(float value);
  public:
...
class detach_item final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.detach_item) */ {
 public:
  inline detach_item() : detach_item(nullptr) {}
  ~detach_item() override;
  explicit PROTOBUF_CONSTEXPR detach_item(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  detach_item(const detach_item& from);
  detach_item(detach_item&& from) noexcept
    : detach_item() {
    *this = ::std::move(from);
  }

  inline detach_item& operator=(const detach_item& from) {
    CopyFrom(from);
    return *this;
  }
  inline detach_item& operator=(detach_item&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const detach_item& default_instance() {
    return *internal_default_instance();
  }
  static inline const detach_item* internal_default_instance() {
    return reinterpret_cast<const detach_item*>(
               &_detach_item_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    23;

  friend void swap(detach_item& a, detach_item& b) {
    a.Swap(&b);
  }
  inline void Swap(detach_item* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(detach_item* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  detach_item* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<detach_item>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const detach_item& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const detach_item& from) {
    detach_item::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(detach_item* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.detach_item";
  }
  protected:
  explicit detach_item(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.detach_item)
 private:
  class _Internal;
...
class slice_vector final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.slice_vector) */ {
 public:
  inline slice_vector() : slice_vector(nullptr) {}
  ~slice_vector() override;
  explicit PROTOBUF_CONSTEXPR slice_vector(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  slice_vector(const slice_vector& from);
  slice_vector(slice_vector&& from) noexcept
    : slice_vector() {
    *this = ::std::move(from);
  }

  inline slice_vector& operator=(const slice_vector& from) {
    CopyFrom(from);
    return *this;
  }
  inline slice_vector& operator=(slice_vector&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const slice_vector& default_instance() {
    return *internal_default_instance();
  }
  static inline const slice_vector* internal_default_instance() {
    return reinterpret_cast<const slice_vector*>(
               &_slice_vector_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    28;

  friend void swap(slice_vector& a, slice_vector& b) {
    a.Swap(&b);
  }
  inline void Swap(slice_vector* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(slice_vector* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  slice_vector* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<slice_vector>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const slice_vector& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const slice_vector& from) {
    slice_vector::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(slice_vector* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.slice_vector";
  }
  protected:
  explicit slice_vector(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  public:
  void clear_normal();
  const ::Protocol::Vector3& normal() const;
  PROTOBUF_NODISCARD ::Protocol::Vector3* release_normal();
  ::Protocol::Vector3* mutable_normal();
  void set_allocated_normal(::Protocol::Vector3* normal);
  private:
  const ::Protocol::Vector3& _internal_normal() const;
  ::Protocol::Vector3* _internal_mutable_normal();
  public:
  void unsafe_arena_set_allocated_normal(
      ::Protocol::Vector3* normal);
  ::Protocol::Vector3* unsafe_arena_release_normal();
  ...
  public:
  void clear_impulse();
  const ::Protocol::Vector3& impulse() const;
  PROTOBUF_NODISCARD ::Protocol::Vector3* release_impulse();
  ::Protocol::Vector3* mutable_impulse();
  void set_allocated_impulse(::Protocol::Vector3* impulse);
  private:
  const ::Protocol::Vector3& _internal_impulse() const;
  ::Protocol::Vector3* _internal_mutable_impulse();
  public:
  void unsafe_arena_set_allocated_impulse(
      ::Protocol::Vector3* impulse);
  ::Protocol::Vector3* unsafe_arena_release_impulse();
  ...
  // @@protoc_insertion_point(class_scope:Protocol.slice_vector)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    ::Protocol::Vector3* normal_;
    ::Protocol::Vector3* impulse_;
    uint32_t packet_type_;
    uint32_t zombieid_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
...
class chatting final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:Protocol.chatting) */ {
 public:
  inline chatting() : chatting(nullptr) {}
  ~chatting() override;
  explicit PROTOBUF_CONSTEXPR chatting(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);

  chatting(const chatting& from);
  chatting(chatting&& from) noexcept
    : chatting() {
    *this = ::std::move(from);
  }

  inline chatting& operator=(const chatting& from) {
    CopyFrom(from);
    return *this;
  }
  inline chatting& operator=(chatting&& from) noexcept {
    if (this == &from) return *this;
    if (GetOwningArena() == from.GetOwningArena()
  #ifdef PROTOBUF_FORCE_COPY_IN_MOVE
        && GetOwningArena() != nullptr
  ...
  static const chatting& default_instance() {
    return *internal_default_instance();
  }
  static inline const chatting* internal_default_instance() {
    return reinterpret_cast<const chatting*>(
               &_chatting_default_instance_);
  }
  static constexpr int kIndexInFileMessages =
    29;

  friend void swap(chatting& a, chatting& b) {
    a.Swap(&b);
  }
  inline void Swap(chatting* other) {
    if (other == this) return;
  #ifdef PROTOBUF_FORCE_COPY_IN_SWAP
    if (GetOwningArena() != nullptr &&
        GetOwningArena() == other->GetOwningArena()) {
  ...
  void UnsafeArenaSwap(chatting* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetOwningArena() == other->GetOwningArena());
    InternalSwap(other);
  }
  ...
  chatting* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
    return CreateMaybeMessage<chatting>(arena);
  }
  using ::PROTOBUF_NAMESPACE_ID::Message::CopyFrom;
  void CopyFrom(const chatting& from);
  using ::PROTOBUF_NAMESPACE_ID::Message::MergeFrom;
  void MergeFrom( const chatting& from) {
    chatting::MergeImpl(*this, from);
  }
  private:
  static void MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg);
  public:
  ...
  void SharedDtor();
  void SetCachedSize(int size) const final;
  void InternalSwap(chatting* other);

  private:
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "Protocol.chatting";
  }
  protected:
  explicit chatting(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                       bool is_message_owned = false);
  public:
  ...
  // @@protoc_insertion_point(class_scope:Protocol.chatting)
 private:
  class _Internal;
...
// uint32 roomnum = 15;
inline void Character::clear_roomnum() {
  _impl_.roomnum_ = 0u;
}
inline uint32_t Character::_internal_roomnum() const {
  return _impl_.roomnum_;
}
inline uint32_t Character::roomnum() const {
  // @@protoc_insertion_point(field_get:Protocol.Character.roomnum)
  return _internal_roomnum();
}
inline void Character::_internal_set_roomnum(uint32_t value) {
  
  _impl_.roomnum_ = value;
}
inline void Character::set_roomnum(uint32_t value) {
  _internal_set_roomnum(value);
  // @@protoc_insertion_point(field_set:Protocol.Character.roomnum)
}
...
// uint32 packet_type = 1;
inline void Zombie_shouting::clear_packet_type() {
  _impl_.packet_type_ = 0u;
}
inline uint32_t Zombie_shouting::_internal_packet_type() const {
  return _impl_.packet_type_;
}
inline uint32_t Zombie_shouting::packet_type() const {
  // @@protoc_insertion_point(field_get:Protocol.Zombie_shouting.packet_type)
  return _internal_packet_type();
}
inline void Zombie_shouting::_internal_set_packet_type(uint32_t value) {
  
  _impl_.packet_type_ = value;
}
inline void Zombie_shouting::set_packet_type(uint32_t value) {
  _internal_set_packet_type(value);
  // @@protoc_insertion_point(field_set:Protocol.Zombie_shouting.packet_type)
}

// uint32 zombieid = 2;
inline void Zombie_shouting::clear_zombieid() {
  _impl_.zombieid_ = 0u;
}
inline uint32_t Zombie_shouting::_internal_zombieid() const {
  return _impl_.zombieid_;
}
inline uint32_t Zombie_shouting::zombieid() const {
  // @@protoc_insertion_point(field_get:Protocol.Zombie_shouting.zombieid)
  return _internal_zombieid();
}
inline void Zombie_shouting::_internal_set_zombieid(uint32_t value) {
  
  _impl_.zombieid_ = value;
}
inline void Zombie_shouting::set_zombieid(uint32_t value) {
  _internal_set_zombieid(value);
  // @@protoc_insertion_point(field_set:Protocol.Zombie_shouting.zombieid)
}

// uint32 playerid = 3;
inline void Zombie_shouting::clear_playerid() {
  _impl_.playerid_ = 0u;
}
inline uint32_t Zombie_shouting::_internal_playerid() const {
  return _impl_.playerid_;
}
inline uint32_t Zombie_shouting::playerid() const {
  // @@protoc_insertion_point(field_get:Protocol.Zombie_shouting.playerid)
  return _internal_playerid();
}
inline void Zombie_shouting::_internal_set_playerid(uint32_t value) {
  
  _impl_.playerid_ = value;
}
inline void Zombie_shouting::set_playerid(uint32_t value) {
  _internal_set_playerid(value);
  // @@protoc_insertion_point(field_set:Protocol.Zombie_shouting.playerid)
}
...
// uint32 packet_type = 1;
inline void ZombiePathList::clear_packet_type() {
  _impl_.packet_type_ = 0u;
}
inline uint32_t ZombiePathList::_internal_packet_type() const {
  return _impl_.packet_type_;
}
inline uint32_t ZombiePathList::packet_type() const {
  // @@protoc_insertion_point(field_get:Protocol.ZombiePathList.packet_type)
  return _internal_packet_type();
}
inline void ZombiePathList::_internal_set_packet_type(uint32_t value) {
  
  _impl_.packet_type_ = value;
}
inline void ZombiePathList::set_packet_type(uint32_t value) {
  _internal_set_packet_type(value);
  // @@protoc_insertion_point(field_set:Protocol.ZombiePathList.packet_type)
}

// repeated .Protocol.ZombiePath zombiepaths = 2;
inline int ZombiePathList::_internal_zombiepaths_size() const {
  return _impl_.zombiepaths_.size();
}
inline int ZombiePathList::zombiepaths_size() const {
  return _internal_zombiepaths_size();
}
inline void ZombiePathList::clear_zombiepaths() {
  _impl_.zombiepaths_.Clear();
}
inline ::Protocol::ZombiePath* ZombiePathList::mutable_zombiepaths(int index) {
  // @@protoc_insertion_point(field_mutable:Protocol.ZombiePathList.zombiepaths)
  return _impl_.zombiepaths_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ZombiePath >*
ZombiePathList::mutable_zombiepaths() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.ZombiePathList.zombiepaths)
  return &_impl_.zombiepaths_;
}
inline const ::Protocol::ZombiePath& ZombiePathList::_internal_zombiepaths(int index) const {
  return _impl_.zombiepaths_.Get(index);
}
inline const ::Protocol::ZombiePath& ZombiePathList::zombiepaths(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.ZombiePathList.zombiepaths)
  return _internal_zombiepaths(index);
}
inline ::Protocol::ZombiePath* ZombiePathList::_internal_add_zombiepaths() {
  return _impl_.zombiepaths_.Add();
}
inline ::Protocol::ZombiePath* ZombiePathList::add_zombiepaths() {
  ::Protocol::ZombiePath* _add = _internal_add_zombiepaths();
  // @@protoc_insertion_point(field_add:Protocol.ZombiePathList.zombiepaths)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::ZombiePath >&
ZombiePathList::zombiepaths() const {
  // @@protoc_insertion_point(field_list:Protocol.ZombiePathList.zombiepaths)
  return _impl_.zombiepaths_;
}
...
// float Durability = 10;
inline void drop_item::clear_durability() {
  _impl_.durability_ = 0;
}
inline float drop_item::_internal_durability() const {
  return _impl_.durability_;
}
inline float drop_item::durability() const {
  // @@protoc_insertion_point(field_get:Protocol.drop_item.Durability)
  return _internal_durability();
}
inline void drop_item::_internal_set_durability(float value) {
  
  _impl_.durability_ = value;
}
inline void drop_item::set_durability(float value) {
  _internal_set_durability(value);
  // @@protoc_insertion_point(field_set:Protocol.drop_item.Durability)
}

// float Durability_Max = 11;
inline void drop_item::clear_durability_max() {
  _impl_.durability_max_ = 0;
}
inline float drop_item::_internal_durability_max() const {
  return _impl_.durability_max_;
}
inline float drop_item::durability_max() const {
  // @@protoc_insertion_point(field_get:Protocol.drop_item.Durability_Max)
  return _internal_durability_max();
}
inline void drop_item::_internal_set_durability_max(float value) {
  
  _impl_.durability_max_ = value;
}
inline void drop_item::set_durability_max(float value) {
  _internal_set_durability_max(value);
  // @@protoc_insertion_point(field_set:Protocol.drop_item.Durability_Max)
}
...
// uint32 packet_type = 1;
inline void detach_item::clear_packet_type() {
  _impl_.packet_type_ = 0u;
}
inline uint32_t detach_item::_internal_packet_type() const {
  return _impl_.packet_type_;
}
inline uint32_t detach_item::packet_type() const {
  // @@protoc_insertion_point(field_get:Protocol.detach_item.packet_type)
  return _internal_packet_type();
}
inline void detach_item::_internal_set_packet_type(uint32_t value) {
  
  _impl_.packet_type_ = value;
}
inline void detach_item::set_packet_type(uint32_t value) {
  _internal_set_packet_type(value);
  // @@protoc_insertion_point(field_set:Protocol.detach_item.packet_type)
}

// uint32 playerid = 2;
inline void detach_item::clear_playerid() {
  _impl_.playerid_ = 0u;
}
inline uint32_t detach_item::_internal_playerid() const {
  return _impl_.playerid_;
}
inline uint32_t detach_item::playerid() const {
  // @@protoc_insertion_point(field_get:Protocol.detach_item.playerid)
  return _internal_playerid();
}
inline void detach_item::_internal_set_playerid(uint32_t value) {
  
  _impl_.playerid_ = value;
}
inline void detach_item::set_playerid(uint32_t value) {
  _internal_set_playerid(value);
  // @@protoc_insertion_point(field_set:Protocol.detach_item.playerid)
}

// uint32 itemtype = 3;
inline void detach_item::clear_itemtype() {
  _impl_.itemtype_ = 0u;
}
inline uint32_t detach_item::_internal_itemtype() const {
  return _impl_.itemtype_;
}
inline uint32_t detach_item::itemtype() const {
  // @@protoc_insertion_point(field_get:Protocol.detach_item.itemtype)
  return _internal_itemtype();
}
inline void detach_item::_internal_set_itemtype(uint32_t value) {
  
  _impl_.itemtype_ = value;
}
inline void detach_item::set_itemtype(uint32_t value) {
  _internal_set_itemtype(value);
  // @@protoc_insertion_point(field_set:Protocol.detach_item.itemtype)
}
...
// uint32 packet_type = 1;
inline void slice_vector::clear_packet_type() {
  _impl_.packet_type_ = 0u;
}
inline uint32_t slice_vector::_internal_packet_type() const {
  return _impl_.packet_type_;
}
inline uint32_t slice_vector::packet_type() const {
  // @@protoc_insertion_point(field_get:Protocol.slice_vector.packet_type)
  return _internal_packet_type();
}
inline void slice_vector::_internal_set_packet_type(uint32_t value) {
  
  _impl_.packet_type_ = value;
}
inline void slice_vector::set_packet_type(uint32_t value) {
  _internal_set_packet_type(value);
  // @@protoc_insertion_point(field_set:Protocol.slice_vector.packet_type)
}

// uint32 zombieid = 2;
inline void slice_vector::clear_zombieid() {
  _impl_.zombieid_ = 0u;
}
inline uint32_t slice_vector::_internal_zombieid() const {
  return _impl_.zombieid_;
}
inline uint32_t slice_vector::zombieid() const {
  // @@protoc_insertion_point(field_get:Protocol.slice_vector.zombieid)
  return _internal_zombieid();
}
inline void slice_vector::_internal_set_zombieid(uint32_t value) {
  
  _impl_.zombieid_ = value;
}
inline void slice_vector::set_zombieid(uint32_t value) {
  _internal_set_zombieid(value);
  // @@protoc_insertion_point(field_set:Protocol.slice_vector.zombieid)
}

// .Protocol.Vector3 location = 3;
inline bool slice_vector::_internal_has_location() const {
  return this != internal_default_instance() && _impl_.location_ != nullptr;
}
inline bool slice_vector::has_location() const {
  return _internal_has_location();
}
inline void slice_vector::clear_location() {
  if (GetArenaForAllocation() == nullptr && _impl_.location_ != nullptr) {
    delete _impl_.location_;
  }
  _impl_.location_ = nullptr;
}
inline const ::Protocol::Vector3& slice_vector::_internal_location() const {
  const ::Protocol::Vector3* p = _impl_.location_;
  return p != nullptr ? *p : reinterpret_cast<const ::Protocol::Vector3&>(
      ::Protocol::_Vector3_default_instance_);
}
inline const ::Protocol::Vector3& slice_vector::location() const {
  // @@protoc_insertion_point(field_get:Protocol.slice_vector.location)
  return _internal_location();
}
inline void slice_vector::unsafe_arena_set_allocated_location(
    ::Protocol::Vector3* location) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.location_);
  }
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.slice_vector.location)
}
inline ::Protocol::Vector3* slice_vector::release_location() {
...
inline ::Protocol::Vector3* slice_vector::unsafe_arena_release_location() {
  // @@protoc_insertion_point(field_release:Protocol.slice_vector.location)
  
  ::Protocol::Vector3* temp = _impl_.location_;
  _impl_.location_ = nullptr;
  return temp;
}
inline ::Protocol::Vector3* slice_vector::_internal_mutable_location() {
...
inline ::Protocol::Vector3* slice_vector::mutable_location() {
  ::Protocol::Vector3* _msg = _internal_mutable_location();
  // @@protoc_insertion_point(field_mutable:Protocol.slice_vector.location)
  return _msg;
}
inline void slice_vector::set_allocated_location(::Protocol::Vector3* location) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.location_;
  }
  ...
  _impl_.location_ = location;
  // @@protoc_insertion_point(field_set_allocated:Protocol.slice_vector.location)
}

// .Protocol.Vector3 position = 4;
inline bool slice_vector::_internal_has_position() const {
  return this != internal_default_instance() && _impl_.position_ != nullptr;
}
inline bool slice_vector::has_position() const {
  return _internal_has_position();
}
inline void slice_vector::clear_position() {
  if (GetArenaForAllocation() == nullptr && _impl_.position_ != nullptr) {
    delete _impl_.position_;
  }
  _impl_.position_ = nullptr;
}
inline const ::Protocol::Vector3& slice_vector::_internal_position() const {
  const ::Protocol::Vector3* p = _impl_.position_;
  return p != nullptr ? *p : reinterpret_cast<const ::Protocol::Vector3&>(
      ::Protocol::_Vector3_default_instance_);
}
inline const ::Protocol::Vector3& slice_vector::position() const {
  // @@protoc_insertion_point(field_get:Protocol.slice_vector.position)
  return _internal_position();
}
inline void slice_vector::unsafe_arena_set_allocated_position(
    ::Protocol::Vector3* position) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.slice_vector.position)
}
inline ::Protocol::Vector3* slice_vector::release_position() {
...
inline ::Protocol::Vector3* slice_vector::unsafe_arena_release_position() {
  // @@protoc_insertion_point(field_release:Protocol.slice_vector.position)
  
  ::Protocol::Vector3* temp = _impl_.position_;
  _impl_.position_ = nullptr;
  return temp;
}
inline ::Protocol::Vector3* slice_vector::_internal_mutable_position() {
...
inline ::Protocol::Vector3* slice_vector::mutable_position() {
  ::Protocol::Vector3* _msg = _internal_mutable_position();
  // @@protoc_insertion_point(field_mutable:Protocol.slice_vector.position)
  return _msg;
}
inline void slice_vector::set_allocated_position(::Protocol::Vector3* position) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.position_;
  }
  ...
  _impl_.position_ = position;
  // @@protoc_insertion_point(field_set_allocated:Protocol.slice_vector.position)
}

// .Protocol.Vector3 normal = 5;
inline bool slice_vector::_internal_has_normal() const {
  return this != internal_default_instance() && _impl_.normal_ != nullptr;
}
inline bool slice_vector::has_normal() const {
  return _internal_has_normal();
}
inline void slice_vector::clear_normal() {
  if (GetArenaForAllocation() == nullptr && _impl_.normal_ != nullptr) {
    delete _impl_.normal_;
  }
  _impl_.normal_ = nullptr;
}
inline const ::Protocol::Vector3& slice_vector::_internal_normal() const {
  const ::Protocol::Vector3* p = _impl_.normal_;
  return p != nullptr ? *p : reinterpret_cast<const ::Protocol::Vector3&>(
      ::Protocol::_Vector3_default_instance_);
}
inline const ::Protocol::Vector3& slice_vector::normal() const {
  // @@protoc_insertion_point(field_get:Protocol.slice_vector.normal)
  return _internal_normal();
}
inline void slice_vector::unsafe_arena_set_allocated_normal(
    ::Protocol::Vector3* normal) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.slice_vector.normal)
}
inline ::Protocol::Vector3* slice_vector::release_normal() {
  
  ::Protocol::Vector3* temp = _impl_.normal_;
  _impl_.normal_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::Protocol::Vector3* slice_vector::unsafe_arena_release_normal() {
  // @@protoc_insertion_point(field_release:Protocol.slice_vector.normal)
  
  ::Protocol::Vector3* temp = _impl_.normal_;
  _impl_.normal_ = nullptr;
  return temp;
}
inline ::Protocol::Vector3* slice_vector::_internal_mutable_normal() {
...
inline ::Protocol::Vector3* slice_vector::mutable_normal() {
  ::Protocol::Vector3* _msg = _internal_mutable_normal();
  // @@protoc_insertion_point(field_mutable:Protocol.slice_vector.normal)
  return _msg;
}
inline void slice_vector::set_allocated_normal(::Protocol::Vector3* normal) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.normal_;
  }
  ...
  _impl_.normal_ = normal;
  // @@protoc_insertion_point(field_set_allocated:Protocol.slice_vector.normal)
}

// .Protocol.Vector3 impulse = 6;
inline bool slice_vector::_internal_has_impulse() const {
  return this != internal_default_instance() && _impl_.impulse_ != nullptr;
}
inline bool slice_vector::has_impulse() const {
  return _internal_has_impulse();
}
inline void slice_vector::clear_impulse() {
  if (GetArenaForAllocation() == nullptr && _impl_.impulse_ != nullptr) {
    delete _impl_.impulse_;
  }
  _impl_.impulse_ = nullptr;
}
inline const ::Protocol::Vector3& slice_vector::_internal_impulse() const {
  const ::Protocol::Vector3* p = _impl_.impulse_;
  return p != nullptr ? *p : reinterpret_cast<const ::Protocol::Vector3&>(
      ::Protocol::_Vector3_default_instance_);
}
inline const ::Protocol::Vector3& slice_vector::impulse() const {
  // @@protoc_insertion_point(field_get:Protocol.slice_vector.impulse)
  return _internal_impulse();
}
inline void slice_vector::unsafe_arena_set_allocated_impulse(
    ::Protocol::Vector3* impulse) {
  if (GetArenaForAllocation() == nullptr) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:Protocol.slice_vector.impulse)
}
inline ::Protocol::Vector3* slice_vector::release_impulse() {
  
  ::Protocol::Vector3* temp = _impl_.impulse_;
  _impl_.impulse_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::Protocol::Vector3* slice_vector::unsafe_arena_release_impulse() {
  // @@protoc_insertion_point(field_release:Protocol.slice_vector.impulse)
  
  ::Protocol::Vector3* temp = _impl_.impulse_;
  _impl_.impulse_ = nullptr;
  return temp;
}
inline ::Protocol::Vector3* slice_vector::_internal_mutable_impulse() {
...
inline ::Protocol::Vector3* slice_vector::mutable_impulse() {
  ::Protocol::Vector3* _msg = _internal_mutable_impulse();
  // @@protoc_insertion_point(field_mutable:Protocol.slice_vector.impulse)
  return _msg;
}
inline void slice_vector::set_allocated_impulse(::Protocol::Vector3* impulse) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.impulse_;
  }
  ...
  _impl_.impulse_ = impulse;
  // @@protoc_insertion_point(field_set_allocated:Protocol.slice_vector.impulse)
}
...
// uint32 packet_type = 1;
inline void chatting::clear_packet_type() {
  _impl_.packet_type_ = 0u;
}
inline uint32_t chatting::_internal_packet_type() const {
  return _impl_.packet_type_;
}
inline uint32_t chatting::packet_type() const {
  // @@protoc_insertion_point(field_get:Protocol.chatting.packet_type)
  return _internal_packet_type();
}
inline void chatting::_internal_set_packet_type(uint32_t value) {
  
  _impl_.packet_type_ = value;
}
inline void chatting::set_packet_type(uint32_t value) {
  _internal_set_packet_type(value);
  // @@protoc_insertion_point(field_set:Protocol.chatting.packet_type)
}

// uint32 playerid = 2;
inline void chatting::clear_playerid() {
  _impl_.playerid_ = 0u;
}
inline uint32_t chatting::_internal_playerid() const {
  return _impl_.playerid_;
}
inline uint32_t chatting::playerid() const {
  // @@protoc_insertion_point(field_get:Protocol.chatting.playerid)
  return _internal_playerid();
}
inline void chatting::_internal_set_playerid(uint32_t value) {
  
  _impl_.playerid_ = value;
}
inline void chatting::set_playerid(uint32_t value) {
  _internal_set_playerid(value);
  // @@protoc_insertion_point(field_set:Protocol.chatting.playerid)
}

// string chat = 3;
inline void chatting::clear_chat() {
  _impl_.chat_.ClearToEmpty();
}
inline const std::string& chatting::chat() const {
  // @@protoc_insertion_point(field_get:Protocol.chatting.chat)
  return _internal_chat();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void chatting::set_chat(ArgT0&& arg0, ArgT... args) {
 
 _impl_.chat_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.chatting.chat)
}
inline std::string* chatting::mutable_chat() {
  std::string* _s = _internal_mutable_chat();
  // @@protoc_insertion_point(field_mutable:Protocol.chatting.chat)
  return _s;
}
inline const std::string& chatting::_internal_chat() const {
  return _impl_.chat_.Get();
}
inline void chatting::_internal_set_chat(const std::string& value) {
  
  _impl_.chat_.Set(value, GetArenaForAllocation());
}
inline std::string* chatting::_internal_mutable_chat() {
  
  return _impl_.chat_.Mutable(GetArenaForAllocation());
}
inline std::string* chatting::release_chat() {
  // @@protoc_insertion_point(field_release:Protocol.chatting.chat)
  return _impl_.chat_.Release();
}
inline void chatting::set_allocated_chat(std::string* chat) {
  if (chat != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:Protocol.chatting.chat)
}
