...
class ZombiePath final :
 ...
 public:
  ...
  // repeated .Protocol.Vector3 path = 2;
  int path_size() const;
  private:
  int _internal_path_size() const;
  public:
  void clear_path();
  ::Protocol::Vector3* mutable_path(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Vector3 >*
      mutable_path();
  private:
  const ::Protocol::Vector3& _internal_path(int index) const;
  ::Protocol::Vector3* _internal_add_path();
  public:
  const ::Protocol::Vector3& path(int index) const;
  ::Protocol::Vector3* add_path();
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Vector3 > path_;
...
// repeated .Protocol.Vector3 path = 2;
inline int ZombiePath::_internal_path_size() const {
  return _impl_.path_.size();
}
inline int ZombiePath::path_size() const {
  return _internal_path_size();
}
inline void ZombiePath::clear_path() {
  _impl_.path_.Clear();
}
inline ::Protocol::Vector3* ZombiePath::mutable_path(int index) {
...
ZombiePath::mutable_path() {
  // @@protoc_insertion_point(field_mutable_list:Protocol.ZombiePath.path)
  return &_impl_.path_;
}
inline const ::Protocol::Vector3& ZombiePath::_internal_path(int index) const {
  return _impl_.path_.Get(index);
}
inline const ::Protocol::Vector3& ZombiePath::path(int index) const {
  // @@protoc_insertion_point(field_get:Protocol.ZombiePath.path)
  return _internal_path(index);
}
inline ::Protocol::Vector3* ZombiePath::_internal_add_path() {
  return _impl_.path_.Add();
}
inline ::Protocol::Vector3* ZombiePath::add_path() {
  ::Protocol::Vector3* _add = _internal_add_path();
  // @@protoc_insertion_point(field_add:Protocol.ZombiePath.path)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::Protocol::Vector3 >&
ZombiePath::path() const {
  // @@protoc_insertion_point(field_list:Protocol.ZombiePath.path)
  return _impl_.path_;
}
