...
void AOneGameModeBase::BeginPlay()
{
    ...
    SpawnItemBoxes(16, "BagActor", EItemClass::BAGITEM, LoadObject<UTexture2D>(NULL, TEXT("/Game/InvenPng/InvenBag.InvenBag"), NULL, LOAD_None, NULL), 1,EItemFloor::FLOORB1); // ���� �ʿ�
