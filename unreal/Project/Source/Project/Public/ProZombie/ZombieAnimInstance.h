...
public:
	...
	void SetIsStandingStill(bool standstill) { m_bIsStandingStill = standstill; }
...
public:
	...
	UPROPERTY(VisibleDefaultsOnly, BlueprintReadOnly, Category = StandingStill, Meta = (AllowPrivateAccess = true))
	bool m_bIsStandingStill;
