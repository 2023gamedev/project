...
ADummyClientCharacter::ADummyClientCharacter()
{
...
void ADummyClientCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ADummyClientCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ADummyClientCharacter::Look);
	}
	else
	{
...
void ADummyClientCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ADummyClientCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
