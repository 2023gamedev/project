...
struct TestPacketDefaultTypeInternal {
  PROTOBUF_CONSTEXPR TestPacketDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~TestPacketDefaultTypeInternal() {}
  union {
    TestPacket _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 TestPacketDefaultTypeInternal _TestPacket_default_instance_;
}  // namespace Protocol
static ::_pb::Metadata file_level_metadata_GStruct_2eproto[1];
...
const uint32_t TableStruct_GStruct_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::Protocol::TestPacket, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ...
  PROTOBUF_FIELD_OFFSET(::Protocol::TestPacket, _impl_.z_),
  PROTOBUF_FIELD_OFFSET(::Protocol::TestPacket, _impl_.pitch_),
  PROTOBUF_FIELD_OFFSET(::Protocol::TestPacket, _impl_.yaw_),
  PROTOBUF_FIELD_OFFSET(::Protocol::TestPacket, _impl_.roll_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::Protocol::TestPacket)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::Protocol::_TestPacket_default_instance_._instance,
};

const char descriptor_table_protodef_GStruct_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\rGStruct.proto\022\010Protocol\"\214\001\n\nTestPacket"
  "\022\020\n\010playerid\030\001 \001(\r\022\023\n\013packet_size\030\002 \001(\r\022"
  "\014\n\004type\030\003 \001(\r\022\t\n\001x\030\004 \001(\002\022\t\n\001y\030\005 \001(\002\022\t\n\001z"
  "\030\006 \001(\002\022\r\n\005pitch\030\007 \001(\002\022\013\n\003yaw\030\010 \001(\002\022\014\n\004ro"
  "ll\030\t \001(\002b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_GStruct_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_GStruct_2eproto = {
    false, false, 176, descriptor_table_protodef_GStruct_2eproto,
    "GStruct.proto",
...
class TestPacket::_Internal {
 public:
};

TestPacket::TestPacket(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:Protocol.TestPacket)
}
TestPacket::TestPacket(const TestPacket& from)
...
inline void TestPacket::SharedCtor(
...
TestPacket::~TestPacket() {
  // @@protoc_insertion_point(destructor:Protocol.TestPacket)
...
inline void TestPacket::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
}

void TestPacket::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void TestPacket::Clear() {
// @@protoc_insertion_point(message_clear_start:Protocol.TestPacket)
...
const char* TestPacket::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
...
uint8_t* TestPacket::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:Protocol.TestPacket)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:Protocol.TestPacket)
  return target;
}

size_t TestPacket::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:Protocol.TestPacket)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData TestPacket::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    TestPacket::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*TestPacket::GetClassData() const { return &_class_data_; }


void TestPacket::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<TestPacket*>(&to_msg);
  auto& from = static_cast<const TestPacket&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:Protocol.TestPacket)
...
void TestPacket::CopyFrom(const TestPacket& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:Protocol.TestPacket)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool TestPacket::IsInitialized() const {
  return true;
}

void TestPacket::InternalSwap(TestPacket* other) {
  using std::swap;
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TestPacket, _impl_.roll_)
      + sizeof(TestPacket::_impl_.roll_)
...
template<> PROTOBUF_NOINLINE ::Protocol::TestPacket*
Arena::CreateMaybeMessage< ::Protocol::TestPacket >(Arena* arena) {
  return Arena::CreateMessageInternal< ::Protocol::TestPacket >(arena);
}
