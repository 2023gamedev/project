...
ZombieController::ZombieController(IOCP_CORE& mainServer)
{
    ...
    // 지하 1층 
    SpawnZombies(10000, 0, Vector3(1800.f, 600.f, 1040.275f), Rotator(0.f, 0.f, 0.f), 2, 1200.f);
    SpawnZombies(10, 0, Vector3(1000.f, 600.f, 1040.275f), Rotator(0.f, 0.f, 0.f), 2, 1200.f);
